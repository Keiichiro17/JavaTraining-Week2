...
感想　今回のプログラムは初心者の自分には難しく、ChatGPTに依存してしまう部分が多かった。本を読んでコードを書くだけではアウトプットとインプットが不十分だと思うので何回も復習し、自分なりにコードを書く機会を増やしていきたいと思う。また、今回のプログラムでは理解できていない部分が多かったので自己学習でゆっくりと理解していきたい。
